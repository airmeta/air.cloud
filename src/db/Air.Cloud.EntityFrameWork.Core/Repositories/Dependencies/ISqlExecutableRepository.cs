...
namespace Air.Cloud.EntityFrameWork.Core.Repositories.Dependencies;
...
public interface IPrivateSqlExecutableRepository : IPrivateRootRepository
{
    ...
    TResult SqlProcedureScalar<TResult>(string procName, params DbParameter[] parameters) where TResult : class, new();
    ...
    /// <param name="model">参数模型</param>
    /// <returns>TResult</returns>
    TResult SqlProcedureScalar<TResult>(string procName, object model) where TResult : class, new();
    ...
    /// <param name="parameters">命令参数</param>
    /// <returns>TResult</returns>
    Task<TResult> SqlProcedureScalarAsync<TResult>(string procName, params DbParameter[] parameters) where TResult : class, new();
    ...
    /// <param name="cancellationToken">异步取消令牌</param>
    /// <returns>TResult</returns>
    Task<TResult> SqlProcedureScalarAsync<TResult>(string procName, DbParameter[] parameters, CancellationToken cancellationToken = default) where TResult : class, new();
    ...
    /// <param name="cancellationToken">异步取消令牌</param>
    /// <returns>TResult</returns>
    Task<TResult> SqlProcedureScalarAsync<TResult>(string procName, object model, CancellationToken cancellationToken = default) where TResult : class, new();
    ...
    /// <param name="parameters">命令参数</param>
    /// <returns>TResult</returns>
    TResult SqlScalar<TResult>(string sql, params DbParameter[] parameters) where TResult : class, new();
    ...
    /// <param name="model">参数模型</param>
    /// <returns>TResult</returns>
    TResult SqlScalar<TResult>(string sql, object model) where TResult : class, new();
    ...
    /// <param name="parameters">命令参数</param>
    /// <returns>TResult</returns>
    Task<TResult> SqlScalarAsync<TResult>(string sql, params DbParameter[] parameters) where TResult : class, new();
    ...
    /// <param name="cancellationToken">异步取消令牌</param>
    /// <returns>TResult</returns>
    Task<TResult> SqlScalarAsync<TResult>(string sql, DbParameter[] parameters, CancellationToken cancellationToken = default) where TResult : class, new();
    ...
    /// <param name="cancellationToken">异步取消令牌</param>
    /// <returns>TResult</returns>
    Task<TResult> SqlScalarAsync<TResult>(string sql, object model, CancellationToken cancellationToken = default) where TResult : class, new();
    ...
    /// <param name="parameters">命令参数</param>
    /// <returns>TResult</returns>
    TResult SqlFunctionScalar<TResult>(string funcName, params DbParameter[] parameters) where TResult : class, new();
    ...
    /// <param name="model">参数模型</param>
    /// <returns>TResult</returns>
    TResult SqlFunctionScalar<TResult>(string funcName, object model) where TResult : class, new();
    ...
    /// <param name="parameters">命令参数</param>
    /// <returns>TResult</returns>
    Task<TResult> SqlFunctionScalarAsync<TResult>(string funcName, params DbParameter[] parameters) where TResult : class, new();
    ...
    /// <param name="cancellationToken">异步取消令牌</param>
    /// <returns>TResult</returns>
    Task<TResult> SqlFunctionScalarAsync<TResult>(string funcName, DbParameter[] parameters, CancellationToken cancellationToken = default) where TResult : class, new();
    ...
    /// <param name="cancellationToken">异步取消令牌</param>
    /// <returns>object</returns>
    Task<TResult> SqlFunctionScalarAsync<TResult>(string funcName, object model, CancellationToken cancellationToken = default) where TResult : class, new();
