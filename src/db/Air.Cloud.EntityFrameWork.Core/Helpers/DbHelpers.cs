...
using Air.Cloud.EntityFrameWork.Core.Attributes;
using Air.Cloud.EntityFrameWork.Core.Enums;
...
namespace Air.Cloud.EntityFrameWork.Core.Helpers;
...
internal static class DbHelpers
{
    ...
    internal static string FixSqlParameterPlaceholder(string providerName, string parameterName, bool isFixed = true)
    {
        ...
        return isFixed ? "@" + parameterName : parameterName;
    }
