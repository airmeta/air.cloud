...
namespace Air.Cloud.Core.Util
{
    ...
    public class TimeHelper
    {
        ...
        /// 获取当前时间戳
        /// </summary>
        /// <param name="bflag">true只取到秒，false取到毫秒</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="unixTimeStamp">秒10位或毫秒13位时间戳</param>
        /// <param name="isMillisecond">是否毫秒</param>
        /// <returns></returns>
        public static DateTime UnixTimeStampToDateTime(long unixTimeStamp, bool isMillisecond = false)
        {
