...
using Air.Cloud.Core.Standard.Dependencies.Enums;
using Air.Cloud.Core.Standard.Dependencies.Options;
using Air.Cloud.Core.Standard.Dependencies.Providers;
...
namespace Air.Cloud.Core.Standard.Dependencies.Extensions;
...
public static class DependencyInjectionServiceCollectionExtensions
{
        ...
        where TIDispatchProxy : class
    {
        ...
        // 获取所有的代理接口类型
        var dispatchProxyInterfaceTypes = AppCore.EffectiveTypes
    ...
    {
        // 获取选项
        var externalServices = AppConfiguration.GetConfig<DependencyInjectionSettingsOptions>("DependencyInjectionSettings", true);
    ...
    public static ServiceLifetime TryGetServiceLifetime(Type dependencyType)
    {
        ...
        {
            throw new InvalidCastException("未知的注册生命周期");
        }
    }
    ...
    {
        // 获取全局代理类型
        GlobalServiceProxyType = AppCore.EffectiveTypes
