...
internal sealed class DynamicApiControllerApplicationModelConvention : IApplicationModelConvention
{
    ...
    {
        _dynamicApiControllerSettings = AppConfiguration.GetConfig<DynamicApiControllerSettingsOptions>("DynamicApiControllerSettings", true);
    ...
    private void LoadVerbToHttpMethodsConfigure()
    {
        ...
        if (verbToHttpMethods is not null)
        {
            ...
            defaultVerbToHttpMethods.Concat(settingsVerbToHttpMethods);
        }
    }
}